...
%perturbed_mr_t1_img_001 = imrotate3(perturbed_mr_t1_img_001, 8, [1 0 0], 'crop', 'FillValues', mode(prealigned_mr_t1_img_001(:)));
%perturbed_mr_t1_img_001 = imrotate3(perturbed_mr_t1_img_001, -16, [0 1 0], 'crop', 'FillValues', mode(prealigned_mr_t1_img_001(:)));
perturbed_mr_t1_img_001 = imrotate3(perturbed_mr_t1_img_001, 16, [0 0 1], 'crop', 'FillValues', mode(prealigned_mr_t1_img_001(:)));
...
%     save([pwd '\registration\z_rotat_registration_workspace']); 
%     
% %% Rotations on y-axis
%    MI4d_r_y_trans = [];
%     D_of_T_r_y_trans = [];
