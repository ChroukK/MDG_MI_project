tic
r_img_lv_0 = mr_t1_img_001(:,:,1:2:26);%512
...
for y=-30:30
    ...
    [f_img_signed_MDG_field f_img_mag_signed_MDG_field] = compute_MDG_vector_field(translated_f_img);
    MI4d = [MI4d compute_4D_MI(translated_f_img, f_img_mag_signed_MDG_field, r_img, r_img_mag_signed_MDG_field, 16)]; 
    D_of_T = [D_of_T compute_angle_measure_D(r_img_signed_MDG_field, f_img_signed_MDG_field, r_img_mag_signed_MDG_field, f_img_mag_signed_MDG_field)]; 
    MI = [MI mi(translated_f_img, r_img)]; 
...
saveas(figure(1),[pwd '\output\S_at_level_4_y_trans_16_bins.fig']); 
saveas(figure(2),[pwd '\output\MI_at_level_4_y_trans_16_bins.fig']); 
