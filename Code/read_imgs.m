...
ct_img_001  = multibandread('image_ct_001.bin',...
                            ...
                            'int16=>single', 0, 'bsq', 'ieee-be' );
ct_img_001_changed  = imref3d(size(ct_img_001),ct_img_001_header.PixelSize(2),ct_img_001_header.PixelSize(1),ct_img_001_header.SliceThickness);
mr_t1_img_001_changed = imref3d(size(mr_t1_img_001),mr_t1_img_001_header.PixelSize(2),mr_t1_img_001_header.PixelSize(1),mr_t1_img_001_header.SliceThickness);
figure
imshow3D(ct_img_001);
